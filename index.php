...
$query = 'SELECT projects.id AS projects, image_banner, class_layout FROM projects, media WHERE media.project_id = projects.id';
      ...
      <section id="contact-form" class="section6 grid-con">
        ...
        <div id="contact-hero-form" class="col-span-full m-col-start-7 m-col-end-13">
            <div class="form">
                ...
                <form id="contact_form" action="email.php" method="POST" enctype="text/plain">
                    <input class="input" name="First Name" type="text" placeholder="First Name">
                    <input class="input" name="Last Name" type="text" placeholder="Last Name">
                    <input class="input" name="contactInfo" type="text" required="" placeholder="Email">
                    <textarea name="msg" placeholder="Message"></textarea>
                </form>
            </div>
            <!-- Submit button outside the div -->
            
        <input id="send-button" name="submit" type="submit" value="Send">
      </div>
    </section>
